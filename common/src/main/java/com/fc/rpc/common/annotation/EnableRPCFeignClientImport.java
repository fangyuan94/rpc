 ...
 */
@Slf4j
public class EnableRPCFeignClientImport implements ImportBeanDefinitionRegistrar, ResourceLoaderAware, EnvironmentAware  {
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        ...
        //获取注解对应配置信息
        AnnotationAttributes enableRPCFeignServer = AnnotationAttributes.fromMap(importingClassMetadata.getAnnotationAttributes(EnableRPCFeignClient.class.getName()));
