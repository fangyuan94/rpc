...
public class EnableConfigurationCenterClientImport implements BeanFactoryAware, ResourceLoaderAware, EnvironmentAware,ImportBeanDefinitionRegistrar {
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        ...
        //获取注解对应配置信息
        AnnotationAttributes annotationAttributes = AnnotationAttributes.fromMap(importingClassMetadata.getAnnotationAttributes(EnableConfigurationCenterClient.class.getName()));
